            	...
            	<div class="w-100">
            		...
            		<div class="d-flex flex-column row-gap-3 ">
	            		...
	            		<div class="row">
		            		...
		            		<div class="tnr line mt-auto col-sm-5 text-center "><?php if (isset($_GET['id'])) {
		            			echo $row['Surname']." ".$row['FirstName']." ".$row['MiddleName'];
		            		} ?></div>
		            		<b class="tnr mt-auto fs-5 col-auto">,</b>
		            		<div class="tnr line mt-auto text-center ms-2 col-sm-1"><?php if (isset($_GET['id'])) { echo $row['Age']; }?></div>
		            		<div class="tnr mt-auto col-sm-2">years old,</div>
	            		</div>
	            		<div class="row d-flex row-gap-2">
		            		<div class="tnr line mt-auto text-center ms-3 col-sm-2"><?php if (isset($_GET['id'])) { echo $row['CivilStatus'];} ?></div>
		            	...
		            	<div class="row d-flex">
		            		<div class="tnr col-sm-2">O.R No.</div>
		            		<div class="tnr line col-sm-3"></div>
		            	</div>
		            	<div class="row d-flex">
		            		<div class="tnr col-sm-2">Date Issued:</div>
		            		<div class="tnr line col-sm-3">
		            			<?php 
		            	...
		            	<div class="row d-flex">
		            		<div class="tnr col-sm-2">Doc. Stamp:</div>
		            		<div class="tnr col-sm-3">Paid</div>
		            	</div>
